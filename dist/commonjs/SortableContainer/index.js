  ...
  return _temp = _class = function (_Component) {
      ...
      _this.handlePress = function (e) {
        ...
        if (active) {
          ...
          if (helperClass) {
            ...
            _this.originTransform = window.getComputedStyle(_this.helper).transform;
          }
    ...
    _createClass(_class, [{
      ...
      value: function updatePosition(e) {
        ...
        this.helper.style[_utils.vendorPrefix + 'Transform'] = 'translate3d(' + translate.x + 'px,' + translate.y + 'px, 0) ' + (this.originTransform || '');
      }
    }, {
      key: 'animateNodes',
